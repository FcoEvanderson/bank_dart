...
abstract class Account {
  ...
  //double balance2() => transactions.fold(0.0, (v, t) => v + t.value);
  ...
  void statementHeader(){
    ...
    centerPrint("EXTRATO DA CONTA $typeName", StatementData.width);
    centerPrint("$agency/$number ${clientName.toUpperCase()}", StatementData.width);
